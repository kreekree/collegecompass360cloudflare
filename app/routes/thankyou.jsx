...
export default function ThankYouRoute() {
  ...
  useEffect(() => {
    if (counter === 0) {
      ...
      window.location.href = `https://email.nogigiddy.com/c/692940af912ed913?email=${email}&utm_source=${utm_source}&utm_medium=${utm_medium}`
    }
  }, [counter, email, utm_source, utm_medium]);
